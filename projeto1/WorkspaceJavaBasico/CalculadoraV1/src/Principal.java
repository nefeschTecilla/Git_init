...
public class Principal {
	...
	// Dúvida aqui nesse Método (por que usei "String ordem"?)
	// 'ordem' é uma variável automática?
	// R: É somente a posição, o nome que está diferente.
	...
	static void mostraResultado(double resultado, int operacao) {
		...
		JOptionPane.showMessageDialog(null, "O resultador da " + op + " é: " + resultado);
	}
}